 ...
 **********************/
    ...
    const Task = ({
      ...
      /*this function is in charge of deleting a task and its subtasks*/
      const handleDelete = (tasks: TaskInterface[], id: string) => {

        dispatch(deleteTask(id));

        const subTasks = tasks.filter((task) => task.mainId === id);
